    ...
    <div class="">
        ...
        <div v-else class="">
            ...
            <div class="container my-[35px]">
                <ul  class="flex justify-center items-center gap-[52px]">
                    <li v-for="tab in tabs" :key="tab.id" @click="activeTab = tab.id" :class="{'border-b-2 border-primary text-primary font-semibold cursor-pointer': activeTab === tab.id, 'text-gray-500 cursor-pointer': activeTab !== tab.id}" class="py-2">
                        {{ tab.name }}
                    </li>
                </ul>
